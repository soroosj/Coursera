...
_WebResourceTextEncodingName^WebResourceURL_WebResourceFrameName_WebResourceData_WebResourceMIMETypeUUTF-8_Qhttps://d18ky98rnyall9.cloudfront.net/_1c4a33b4ab16a6a9437f293400029738_simple_regression_Coursera.Rmd?Expires=1540166400&Signature=hoJeAWrsoragUSKC4MNG04GQs2kEyJHxeqRt9pYZtG3B-55KIDeCxus8xVl45VopRoTtsFCWpPcq6VCNSnzVK25WOpON14kl8pBGBFXzAUz0YDt87VgI0oS7MxlruOLsj9eVK0TL6xG3t2ezJswyck6dppvkW2VX7a-D8rNM~Sw_&Key-Pair-Id=APKAJLTNE6QMUY6HBC5APO<?<html><head></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">---
...
ggplot(data = mlb11, aes(x = new_obs, y = runs)) +
  geom_point() +
  stat_smooth(method = "lm", se = FALSE) + 
  geom_hline(yintercept = mean(mlb11$runs))
...
&lt;/div&gt;</pre></body></html>Ztext/plain    ( F U l ~ ? ???>?             
              >?